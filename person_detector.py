...
def open_graph():
    ...
    with detection_graph.as_default():
        ...
        os_path = 'F://program_files/auto-tinder-dependabot-pip-tensorflow-2.5.1_redact'
        with open(os_path + '/ssd_mobilenet_v1_coco_2017_11_17/frozen_inference_graph.pb', "rb") as f:
            serialized_graph = od_graph_def.ParseFromString(f.read())
